...
class Window:
    def __init__(self):
        ...
        self.textbox_epochs = TextBox(plt.axes([0.440, 0.05, 0.100, 0.03]), 'Epochs:')
        fit_button = Button(plt.axes([0.650, 0.05, 0.1, 0.03]), 'Fit')
    ...
    def clean(self, event):
        ...
        self.cartesian_plane.set_xlim(-1.0,1.0)
        self.cartesian_plane.set_ylim(-1.0,1.0)
        self.textbox_has_converged.set_val('')
